...
<body>
	<div class="form-horizontal">
		<form action="ListDatabaseTables" method="post">
			<p>Atualizar lista de entidades a partir das tabelas do banco de dados.</p>
			<input type="submit" value="Consultar MySQL" class="btn btn-lg btn-primary">
		</form>
	</div>	
</body>
</html>